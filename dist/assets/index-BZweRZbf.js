...
Shared j-inv:  ${t}
    `.replace(/\n/g,"<br/>")}catch(e){p.textContent=`Error: ${String(e)}`}});const N=document.getElementById("btn-run-attack"),v=document.getElementById("attack-output");N.addEventListener("click",async()=>{v.textContent="Running attack...";try{const e=await x(),t=k(e.alice.publicKey),o=`
...
(Original secret was: ${e.alice.privateKey})
    `.replace(/\n/g,"<br/>");v.innerHTML=o}catch(e){v.textContent=`Error: ${String(e)}`}});T.setAttribute("data-theme",g);
